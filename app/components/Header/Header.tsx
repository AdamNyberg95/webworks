...
import {  BtnPrimarySmall, BtnSmallTypography, Container, Logga, LoggoNavWrapper, NavLinks, NavList, Wrapper} from './Header.styled';
...
useEffect(() => {
  ...
  return (
    <Container>
      ...
      <NavList >
        <LoggoNavWrapper>
      <Logga><Link href={`/`} ><Image src={logga2} alt="logga"  width={75} height={65}/> </Link></Logga>
